...
/* cmd time,  <---------------------------- cmd pkt primary header ---------------------------->     <----- cmd pkt 2nd header ---->           <-- opt data ---> */
  ...
  1,          CFE_MAKE_BIG16(TO_LAB_CMD_MID),     CFE_MAKE_BIG16(PKT_FLAGS), CFE_MAKE_BIG16(21),     CFE_MAKE_BIG16(TO_DEBUG_ENABLE_CC),       0x6F63, 0x6D73, 0x736F, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0095, 0x1300, // Enable Debug, cosmos, 5013
